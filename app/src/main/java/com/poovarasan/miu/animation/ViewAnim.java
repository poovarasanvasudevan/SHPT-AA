...
public class ViewAnim extends Animation {
    ...
    private static final WeakHashMap<View, ViewAnim> PROXIES = new WeakHashMap<View, ViewAnim>();

    public static ViewAnim wrap(View view) {
        ViewAnim proxy = PROXIES.get(view);
        Animation animation = view.getAnimation();
        if (proxy == null || proxy != animation && animation != null) {
            proxy = new ViewAnim(view);
