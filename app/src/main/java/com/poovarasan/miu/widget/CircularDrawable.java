...
import com.poovarasan.miu.widget.notification.NotificationDrawer;
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        for (int i = 0; i < sourceObjects.size(); i++) {
            ...
            if (sourceObject instanceof BitmapDrawer) {
                ...
                bitmapDrawer.bitmapShader.setLocalMatrix(getLocalMatrix(scaleType, mRect, mBorderWidth, bitmapDrawer.bitmap, drawerHelper.getDrawingType(i, sourceObjects.size())));
            }
        }
