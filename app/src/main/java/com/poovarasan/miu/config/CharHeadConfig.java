package com.poovarasan.miu.config;
...
public class CharHeadConfig extends ChatHeadDefaultConfig {
    public CharHeadConfig(Context context) {
        super(context);
    }

    public CharHeadConfig(Context context, int xPosition, int yPosition) {
        super(context);
